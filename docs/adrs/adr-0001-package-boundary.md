# ADR-0001: @plasius/ai-rag Package Boundary
...
Create `@plasius/ai-rag` as a standalone public package with independent build, test, governance, and publish readiness. The package starts with a narrow descriptor contract and will receive implementation through tracked Feature/Story/Task work.
